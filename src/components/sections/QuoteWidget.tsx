              ...
              <AnimatePresence mode="wait">
                {submitted ? (
                  ...
                  >
                    ...
                    <a
                      href="tel:0800700900"
                      className="inline-flex items-center gap-2 mt-6 bg-brand-500 text-white rounded-xl px-6 py-3 font-semibold text-body-sm"
                    >
                  ...
                  >
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full rounded-xl border border-ink-200 px-4 py-3 text-body-sm text-ink-700 focus:ring-2 focus:ring-brand-500 focus:border-brand-500 outline-none transition-all bg-white"
                      >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full rounded-xl border border-ink-200 px-4 py-3 text-body-sm text-ink-700 focus:ring-2 focus:ring-brand-500 focus:border-brand-500 outline-none transition-all"
                        min={18}
                        max={65}
                      />
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="w-full bg-brand-500 hover:bg-brand-600 text-white rounded-xl py-4 font-semibold text-body-lg flex items-center justify-center gap-2 transition-colors disabled:opacity-70"
                    >
                      {loading ? (
